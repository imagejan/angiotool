 ...
 *
 * Based on Wayne Rasband. ImageJ RGBStackSplitter
...
public class RGBStackSplitter {
    ...
    public static ImageStack red, green, blue;
    ...
    public static ImagePlus split(ImagePlus imp, String channel) {
        ...
        ImageStatistics redStats = ImageStatistics.getStatistics(red.getProcessor(1), ImageStatistics.MEAN, cal);
        ImageStatistics greenStats = ImageStatistics.getStatistics(green.getProcessor(1), ImageStatistics.MEAN, cal);
        ImageStatistics blueStats = ImageStatistics.getStatistics(blue.getProcessor(1), ImageStatistics.MEAN, cal);
